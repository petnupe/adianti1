<?php
/**
 * PatologiaPacienteFormList Form List
 * @author  <your name here>
 */
class PatologiaPacienteFormList extends TPage
{
    protected $form; // form
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for PatologiaPaciente
            $repository = new TRepository('PatologiaPaciente');
            $limit = 10;
            // creates a criteria
