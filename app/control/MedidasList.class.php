 ...
 */
class MedidasList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->setActiveRecord('Medidas');   // defines the active record
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_search_Medidas');
        ...
        $this->form->addActionLink(_t('New'), new TAction(['MedidasForm', 'onEdit']), 'fa:plus green');
        ...
        $action1 = new TDataGridAction(['MedidasForm', 'onEdit'], ['id'=>'{id}']);
