<?php
/**
 * MedidasFormList Form List
 * @author  <your name here>
 */
class MedidasFormList extends TPage
{
    protected $form; // form
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for Medidas
            $repository = new TRepository('Medidas');
            $limit = 10;
            // creates a criteria
    ...
    public static function Delete($param)
    {
        try
        {
            ...
            $object = new Medidas($key, FALSE); // instantiates the Active Record
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            **/
            ...
            $object = new Medidas;  // create an empty object
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                $key = $param['key'];  // get the parameter $key
                TTransaction::open('db'); // open a transaction
                $object = new Medidas($key); // instantiates the Active Record
