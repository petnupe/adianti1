<?php
/**
 * ResponsavelFormList Form List
 * @author  <your name here>
 */
class ResponsavelFormList extends TPage
{
    protected $form; // form
    ...
    public function __construct( $param )
    {
        ...
        $this->form->setFormTitle('Responsável');
        ...
        $column_parentesco_id = new TDataGridColumn('parentesco_id', 'Parentesco', 'left');
        ...
        $column_parentesco_id->setTransformer([$this, 'getNomeParentesco']);
        $this->datagrid->addColumn($column_parentesco_id);
        
        $column_paciente_id->setTransformer([$this, 'getNomePaciente']);
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            $object->nome = mb_strtoupper($object->nome);
    ...
    public function getNomeParentesco($id) {
        $Parentesco = new Parentesco($id);
